        ...
        >
          {statusOptions.map((option) => {
            ...
            return (
              <label
                key={option.value}
                className="flex cursor-pointer items-center gap-2.5 rounded-lg border border-input px-3 py-2 text-sm transition-colors hover:bg-muted/50 has-:checked:border-primary"
              >
                <input
                  type="radio"
                  name={`${prefix}Status`}
