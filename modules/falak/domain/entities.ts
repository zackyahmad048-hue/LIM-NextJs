...
export class FalakPrayerTime extends BaseEntity<FalakPrayerTimeProps> {
  ...
  get calculationMethod(): PrayerMethod {
    return this.props.calculationMethod;
  }
  get prayerDate(): Date {
    return this.props.prayerDate;
  }
  get fajr(): Date {
    return this.props.fajr;
  }
  get sunrise(): Date {
    return this.props.sunrise;
  }
  get dhuhr(): Date {
    return this.props.dhuhr;
  }
  get asr(): Date {
    return this.props.asr;
  }
  get maghrib(): Date {
    return this.props.maghrib;
  }
  get isha(): Date {
    return this.props.isha;
  }
...
export class FalakRukyat extends BaseEntity<FalakRukyatProps> {
  ...
  get observationDate(): Date {
    return this.props.observationDate;
  }
  get locationName(): string {
    return this.props.locationName;
  }
