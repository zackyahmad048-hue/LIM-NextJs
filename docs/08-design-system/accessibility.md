...
Animasi harus purposeful dan tidak mengganggu.
...
- Konten yang diturunkan dari waktu nyata (jam live, hitung mundur) wajib merender placeholder stabil saat SSR agar tidak terjadi hydration mismatch; pola acuan: `components/website/falak/prayer-schedule-widget.tsx` (widget shalat di hero) memakai guard mounted sebelum merender data waktu nyata.
