...
**Status:** Approved
**Pemilik:** admin `app/(dashboard)/admin/` — sistem permukaan & komposisi halaman admin
**Tanggal:** 2026-09-06
...
*Spec ini dipromosikan dari `.scratch/admin-redesign/spec.md` saat map wayfinding (ticket 01–05) selesai dan disetujui. Draft kerja tetap di `.scratch/admin-redesign/`; perbarui di sana lalu salin ulang ketika berubah.*