...
- [07 Tracer-bullet LIST — petugas unit](.scratch/admin-redesign/issues/07-tracer-bullet-list-officers.md) — blocker: 06
...
Status implementasi: 06 resolved (primitif + data-table admin, validasi penuh) → frontier berikut 07/08/09.
